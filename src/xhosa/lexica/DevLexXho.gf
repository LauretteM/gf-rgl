concrete DevLexXho of DevLex = CatXho ** open ResXho,ParadigmsXho in {
   ...
   be_hot_V = mkV "tshis" ;
   be_healthy_V = mkV "phil" ; -- not sure, keeping on for now
   -- be_fast_V = mkV "shes" ;
