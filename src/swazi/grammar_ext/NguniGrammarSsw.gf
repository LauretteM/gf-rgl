...
concrete NguniGrammarSsw of NguniGrammar =
  ...
  -- ConjunctionSsw,
  PhraseSsw [PhrUtt, UttS, UttQS, UttImpSg, NoPConj, NoVoc, VocNP],
  TextX - [Temp,Adv,IAdv],
  StructuralSsw [and_Conj,how_IAdv,how8much_IAdv,i_Pron,youSg_Pron,he_Pron,she_Pron,we_Pron,youPl_Pron,they_Pron,this_Quant,that_Quant,all_Predet,only_Predet,very_AdA],
  -- Idiom,
  TenseX [PPos,PNeg],
  -- Transfer ,
