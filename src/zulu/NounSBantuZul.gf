concrete NounSBantuZul of NounSBantu = CatZul,CatSBantuZul ** open ResZul, Prelude, ParamX in {
  ...
  lin
    ...
    SBantuConjNP np1 conj np2 = {
      s = table {
        ...
        nform => np1.s!nform ++ conj.s!(initNP np2.isPron np2.agr) ++ np2.s!NReduced 
      } ;
