concrete StructuralNso of Structural = CatNso **
  open
    -- MorphoNso,
    ResNso, ParadigmsNso, Prelude, ParamX in {
  ...
  -- Pron
    i_Pron = mkPron "nna" "ka" (First Sg) ;
    we_Pron = mkPron "rena" "rena" (First Pl) ;

    youSg_Pron = mkPron "wena" "gago" (Second Sg) ;
