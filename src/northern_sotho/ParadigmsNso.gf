...
oper
  ...
  mkV = overload {
    ...
    mkV : (r,re,itse : Str) -> V = \r,re,itse -> lin V (mkVerbIrregular re itse) ;
  } ;
  ...
  mkVS = overload {
    ...
    mkVS : (bon : Str) -> MoodS -> VS  = \bon,mood -> lin VS (mkVerb bon) ** { mood = mood } ; 
    mkVS : (bon,bonile : Str) -> MoodS -> VS  = \bon,bonile,mood -> lin VS (mkVerbExplicit bon bonile) ** { mood = mood } ; 
    mkVS : (r,re,itse : Str) -> MoodS -> VS = \r,re,itse,mood -> lin VS (mkVerbIrregular re itse) ** { mood =  mood } ; 
  } ;
